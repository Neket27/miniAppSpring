...
public class ImageMapperImpl implements ImageMapper {
    ...
    @Override
    public List<Image> toImageListFromCreate(List<CreateImageDto> createImageDtoList) {
    ...
    @Override
    public List<Image> toImageListFromUpdate(List<UpdateImageDto> updateImageDtoList) {
        if ( updateImageDtoList == null ) {
            return null;
        }
